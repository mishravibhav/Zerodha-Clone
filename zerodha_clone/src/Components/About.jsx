    ...
    return(
        ...
        <div className="About__para__container">
            <div className="About__para">
                ...
                <p>Over 4+ million clients place millions of orders every day through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p>
            </div>
            <div className="About__para">
